{
  ...
  spec: {
    ...
    '#extensions':: d.obj(help='"The list of extensions to be managed in the database"'),
    extensions: {
      '#withEnsure':: d.fn(help='"Specifies whether an object (e.g schema) should be present or absent\\nin the database. If set to `present`, the object will be created if\\nit does not exist. If set to `absent`, the extension/schema will be\\nremoved if it exists."', args=[d.arg(name='ensure', type=d.T.string)]),
      withEnsure(ensure): { ensure: ensure },
      '#withName':: d.fn(help='"Name of the object (extension, schema, FDW, server)"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withSchema':: d.fn(help="\"The name of the schema in which to install the extension's objects,\\nin case the extension allows its contents to be relocated. If not\\nspecified (default), and the extension's control file does not\\nspecify a schema either, the current default object creation schema\\nis used.\"", args=[d.arg(name='schema', type=d.T.string)]),
      withSchema(schema): { schema: schema },
      '#withVersion':: d.fn(help="\"The version of the extension to install. If empty, the operator will\\ninstall the default version (whatever is specified in the\\nextension's control file)\"", args=[d.arg(name='version', type=d.T.string)]),
      withVersion(version): { version: version },
    },
    '#fdws':: d.obj(help='"The list of foreign data wrappers to be managed in the database"'),
    fdws: {
      '#options':: d.obj(help='"Options specifies the configuration options for the FDW."'),
      options: {
        '#withEnsure':: d.fn(help='"Specifies whether an option should be present or absent in\\nthe database. If set to `present`, the option will be\\ncreated if it does not exist. If set to `absent`, the\\noption will be removed if it exists."', args=[d.arg(name='ensure', type=d.T.string)]),
        withEnsure(ensure): { ensure: ensure },
        '#withName':: d.fn(help='"Name of the option"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withValue':: d.fn(help='"Value of the option"', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { value: value },
      },
      '#usage':: d.obj(help='"List of roles for which `USAGE` privileges on the FDW are granted or revoked."'),
      usage: {
        '#withName':: d.fn(help='"Name of the usage"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withType':: d.fn(help='"The type of usage"', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { type: type },
      },
      '#withEnsure':: d.fn(help='"Specifies whether an object (e.g schema) should be present or absent\\nin the database. If set to `present`, the object will be created if\\nit does not exist. If set to `absent`, the extension/schema will be\\nremoved if it exists."', args=[d.arg(name='ensure', type=d.T.string)]),
      withEnsure(ensure): { ensure: ensure },
      '#withHandler':: d.fn(help='"Name of the handler function (e.g., \\"postgres_fdw_handler\\").\\nThis will be empty if no handler is specified. In that case,\\nthe default handler is registered when the FDW extension is created."', args=[d.arg(name='handler', type=d.T.string)]),
      withHandler(handler): { handler: handler },
      '#withName':: d.fn(help='"Name of the object (extension, schema, FDW, server)"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withOptions':: d.fn(help='"Options specifies the configuration options for the FDW."', args=[d.arg(name='options', type=d.T.array)]),
      withOptions(options): { options: if std.isArray(v=options) then options else [options] },
      '#withOptionsMixin':: d.fn(help='"Options specifies the configuration options for the FDW."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='options', type=d.T.array)]),
      withOptionsMixin(options): { options+: if std.isArray(v=options) then options else [options] },
      '#withOwner':: d.fn(help='"Owner specifies the database role that will own the Foreign Data Wrapper.\\nThe role must have superuser privileges in the target database."', args=[d.arg(name='owner', type=d.T.string)]),
      withOwner(owner): { owner: owner },
      '#withUsage':: d.fn(help='"List of roles for which `USAGE` privileges on the FDW are granted or revoked."', args=[d.arg(name='usage', type=d.T.array)]),
      withUsage(usage): { usage: if std.isArray(v=usage) then usage else [usage] },
      '#withUsageMixin':: d.fn(help='"List of roles for which `USAGE` privileges on the FDW are granted or revoked."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='usage', type=d.T.array)]),
      withUsageMixin(usage): { usage+: if std.isArray(v=usage) then usage else [usage] },
      '#withValidator':: d.fn(help='"Name of the validator function (e.g., \\"postgres_fdw_validator\\").\\nThis will be empty if no validator is specified. In that case,\\nthe default validator is registered when the FDW extension is created."', args=[d.arg(name='validator', type=d.T.string)]),
      withValidator(validator): { validator: validator },
    },
    '#schemas':: d.obj(help='"The list of schemas to be managed in the database"'),
    schemas: {
      '#withEnsure':: d.fn(help='"Specifies whether an object (e.g schema) should be present or absent\\nin the database. If set to `present`, the object will be created if\\nit does not exist. If set to `absent`, the extension/schema will be\\nremoved if it exists."', args=[d.arg(name='ensure', type=d.T.string)]),
      withEnsure(ensure): { ensure: ensure },
      '#withName':: d.fn(help='"Name of the object (extension, schema, FDW, server)"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withOwner':: d.fn(help='"The role name of the user who owns the schema inside PostgreSQL.\\nIt maps to the `AUTHORIZATION` parameter of `CREATE SCHEMA` and the\\n`OWNER TO` command of `ALTER SCHEMA`."', args=[d.arg(name='owner', type=d.T.string)]),
      withOwner(owner): { owner: owner },
    },
    '#servers':: d.obj(help='"The list of foreign servers to be managed in the database"'),
    servers: {
      '#options':: d.obj(help='"Options specifies the configuration options for the server\\n(key is the option name, value is the option value)."'),
      options: {
        '#withEnsure':: d.fn(help='"Specifies whether an option should be present or absent in\\nthe database. If set to `present`, the option will be\\ncreated if it does not exist. If set to `absent`, the\\noption will be removed if it exists."', args=[d.arg(name='ensure', type=d.T.string)]),
        withEnsure(ensure): { ensure: ensure },
        '#withName':: d.fn(help='"Name of the option"', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#usage':: d.obj(help='"List of roles for which `USAGE` privileges on the server are granted or revoked."'),
      usage: {
        '#withName':: d.fn(help='"Name of the usage"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withType':: d.fn(help='"The type of usage"', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withEnsure':: d.fn(help='"Specifies whether an object (e.g schema) should be present or absent\\nin the database. If set to `present`, the object will be created if\\nit does not exist. If set to `absent`, the extension/schema will be\\nremoved if it exists."', args=[d.arg(name='ensure', type=d.T.string)]),
      withEnsure(ensure): { ensure: ensure },
      '#withFdw':: d.fn(help='"The name of the Foreign Data Wrapper (FDW)"', args=[d.arg(name='fdw', type=d.T.string)]),
      withFdw(fdw): { fdw: fdw },
      '#withName':: d.fn(help='"Name of the object (extension, schema, FDW, server)"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withOptions':: d.fn(help='"Options specifies the configuration options for the server\\n(key is the option name, value is the option value)."', args=[d.arg(name='options', type=d.T.array)]),
      withOptions(options): { options: if std.isArray(v=options) then options else [options] },
      '#withOptionsMixin':: d.fn(help='"Options specifies the configuration options for the server\\n(key is the option name, value is the option value)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='options', type=d.T.array)]),
      withOptionsMixin(options): { options+: if std.isArray(v=options) then options else [options] },
      '#withUsage':: d.fn(help='"List of roles for which `USAGE` privileges on the server are granted or revoked."', args=[d.arg(name='usage', type=d.T.array)]),
      withUsage(usage): { usage: if std.isArray(v=usage) then usage else [usage] },
      '#withUsageMixin':: d.fn(help='"List of roles for which `USAGE` privileges on the server are granted or revoked."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='usage', type=d.T.array)]),
      withUsageMixin(usage): { usage+: if std.isArray(v=usage) then usage else [usage] },
    },
    ...
    '#withExtensions':: d.fn(help='"The list of extensions to be managed in the database"', args=[d.arg(name='extensions', type=d.T.array)]),
    withExtensions(extensions): { spec+: { extensions: if std.isArray(v=extensions) then extensions else [extensions] } },
    '#withExtensionsMixin':: d.fn(help='"The list of extensions to be managed in the database"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extensions', type=d.T.array)]),
    withExtensionsMixin(extensions): { spec+: { extensions+: if std.isArray(v=extensions) then extensions else [extensions] } },
    '#withFdws':: d.fn(help='"The list of foreign data wrappers to be managed in the database"', args=[d.arg(name='fdws', type=d.T.array)]),
    withFdws(fdws): { spec+: { fdws: if std.isArray(v=fdws) then fdws else [fdws] } },
    '#withFdwsMixin':: d.fn(help='"The list of foreign data wrappers to be managed in the database"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fdws', type=d.T.array)]),
    withFdwsMixin(fdws): { spec+: { fdws+: if std.isArray(v=fdws) then fdws else [fdws] } },
    ...
    '#withSchemas':: d.fn(help='"The list of schemas to be managed in the database"', args=[d.arg(name='schemas', type=d.T.array)]),
    withSchemas(schemas): { spec+: { schemas: if std.isArray(v=schemas) then schemas else [schemas] } },
    '#withSchemasMixin':: d.fn(help='"The list of schemas to be managed in the database"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='schemas', type=d.T.array)]),
    withSchemasMixin(schemas): { spec+: { schemas+: if std.isArray(v=schemas) then schemas else [schemas] } },
    '#withServers':: d.fn(help='"The list of foreign servers to be managed in the database"', args=[d.arg(name='servers', type=d.T.array)]),
    withServers(servers): { spec+: { servers: if std.isArray(v=servers) then servers else [servers] } },
    '#withServersMixin':: d.fn(help='"The list of foreign servers to be managed in the database"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='servers', type=d.T.array)]),
