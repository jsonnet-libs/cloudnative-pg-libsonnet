{
  ...
  spec: {
    ...
    extensions: {
      '#withEnsure':: d.fn(help='"Specifies whether an extension/schema should be present or absent in\\nthe database. If set to `present`, the extension/schema will be\\ncreated if it does not exist. If set to `absent`, the\\nextension/schema will be removed if it exists."', args=[d.arg(name='ensure', type=d.T.string)]),
      withEnsure(ensure): { ensure: ensure },
      '#withName':: d.fn(help='"Name of the extension/schema"', args=[d.arg(name='name', type=d.T.string)]),
