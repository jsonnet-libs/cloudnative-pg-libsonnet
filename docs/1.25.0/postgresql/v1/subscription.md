---
permalink: /1.25.0/postgresql/v1/subscription/
---

# postgresql.v1.subscription
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withExternalClusterName(externalClusterName)`](#fn-specwithexternalclustername)
  ...
  * [`fn withPublicationDBName(publicationDBName)`](#fn-specwithpublicationdbname)
  * [`fn withPublicationName(publicationName)`](#fn-specwithpublicationname)
  * [`fn withSubscriptionReclaimPolicy(subscriptionReclaimPolicy)`](#fn-specwithsubscriptionreclaimpolicy)
...
### fn spec.withExternalClusterName

```ts
withExternalClusterName(externalClusterName)
```
...
### fn spec.withPublicationDBName

```ts
withPublicationDBName(publicationDBName)
```
...
### fn spec.withPublicationName

```ts
withPublicationName(publicationName)
```

"The name of the publication inside the PostgreSQL database in the\n\"publisher\

### fn spec.withSubscriptionReclaimPolicy

```ts
withSubscriptionReclaimPolicy(subscriptionReclaimPolicy)
```
