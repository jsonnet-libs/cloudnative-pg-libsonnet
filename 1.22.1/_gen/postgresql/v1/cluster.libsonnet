  ...
  spec: {
    ...
    backup: {
      ...
      volumeSnapshot: {
        ...
        '#withOnline':: d.fn(help='"Whether the default type of backup with volume snapshots is online/hot (`true`, default) or offline/cold (`false`)"', args=[d.arg(name='online', type=d.T.boolean)]),
        ...
        '#withTablespaceClassName':: d.fn(help='"TablespaceClassName specifies the Snapshot Class to be used for the tablespaces. defaults to the PGDATA Snapshot Class, if set"', args=[d.arg(name='tablespaceClassName', type=d.T.object)]),
        withTablespaceClassName(tablespaceClassName): { spec+: { backup+: { volumeSnapshot+: { tablespaceClassName: tablespaceClassName } } } },
        '#withTablespaceClassNameMixin':: d.fn(help='"TablespaceClassName specifies the Snapshot Class to be used for the tablespaces. defaults to the PGDATA Snapshot Class, if set"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tablespaceClassName', type=d.T.object)]),
      ...
      volumeClaimTemplate: {
        ...
        spec: {
          ...
          resources: {
            ...
            withClaims(claims): { spec+: { ephemeralVolumeSource+: { volumeClaimTemplate+: { spec+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } } } },
            ...
            withClaimsMixin(claims): { spec+: { ephemeralVolumeSource+: { volumeClaimTemplate+: { spec+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } } } },
    ...
    postgresql: {
      ...
      '#withEnableAlterSystem':: d.fn(help='"If this parameter is true, the user will be able to invoke `ALTER SYSTEM` on this CloudNativePG Cluster. This should only be used for debugging and troubleshooting. Defaults to false."', args=[d.arg(name='enableAlterSystem', type=d.T.boolean)]),
      ...
      '#withPg_ident':: d.fn(help='"PostgreSQL User Name Maps rules (lines to be appended to the pg_ident.conf file)"', args=[d.arg(name='pg_ident', type=d.T.array)]),
      withPg_ident(pg_ident): { spec+: { postgresql+: { pg_ident: if std.isArray(v=pg_ident) then pg_ident else [pg_ident] } } },
      '#withPg_identMixin':: d.fn(help='"PostgreSQL User Name Maps rules (lines to be appended to the pg_ident.conf file)"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pg_ident', type=d.T.array)]),
    ...
    storage: {
      ...
      '#withStorageClass':: d.fn(help='"StorageClass to use for PVCs. Applied after evaluating the PVC template, if available. If not specified, the generated PVCs will use the default storage class"', args=[d.arg(name='storageClass', type=d.T.string)]),
    ...
    tablespaces: {
      ...
      storage: {
        ...
        pvcTemplate: {
          ...
          resources: {
            ...
            '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
            withClaims(claims): { storage+: { pvcTemplate+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } },
            '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
            withClaimsMixin(claims): { storage+: { pvcTemplate+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } },
            '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
      ...
      withName(name): { name: name },
      '#withTemporary':: d.fn(help='"When set to true, the tablespace will be added as a `temp_tablespaces` entry in PostgreSQL, and will be available to automatically house temp database objects, or other temporary files. Please refer to PostgreSQL documentation for more information on the `temp_tablespaces` GUC."', args=[d.arg(name='temporary', type=d.T.boolean)]),
