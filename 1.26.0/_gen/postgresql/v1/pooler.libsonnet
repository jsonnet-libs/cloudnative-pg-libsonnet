{
  ...
  '#spec':: d.obj(help='"Specification of the desired behavior of the Pooler.\\nMore info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
  spec: {
    '#cluster':: d.obj(help='"This is the cluster reference on which the Pooler will work.\\nPooler name should never match with any cluster name within the same namespace."'),
    cluster: {
    ...
    pgbouncer: {
      ...
      '#clientCASecret':: d.obj(help='"ClientCASecret provides PgBouncer’s client_tls_ca_file, the root\\nCA for validating client certificates"'),
      clientCASecret: {
        '#withName':: d.fn(help='"Name of the referent."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { pgbouncer+: { clientCASecret+: { name: name } } } },
      },
      '#clientTLSSecret':: d.obj(help='"ClientTLSSecret provides PgBouncer’s client_tls_key_file (private key)\\nand client_tls_cert_file (certificate) used to accept client connections"'),
      clientTLSSecret: {
        '#withName':: d.fn(help='"Name of the referent."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      serverCASecret: {
        '#withName':: d.fn(help='"Name of the referent."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { pgbouncer+: { serverCASecret+: { name: name } } } },
      },
      '#serverTLSSecret':: d.obj(help="\"ServerTLSSecret, when pointing to a TLS secret, provides pgbouncer's\\n`server_tls_key_file` and `server_tls_cert_file`, used when\\nauthenticating against PostgreSQL.\""),
      serverTLSSecret: {
        '#withName':: d.fn(help='"Name of the referent."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { pgbouncer+: { serverTLSSecret+: { name: name } } } },
      },
    ...
    '#serviceTemplate':: d.obj(help='"Template for the Service to be created"'),
    serviceTemplate: {
      ...
      spec: {
        ...
        sessionAffinityConfig: {
          ...
          clientIP: {
            ...
            withTimeoutSeconds(timeoutSeconds): { spec+: { serviceTemplate+: { spec+: { sessionAffinityConfig+: { clientIP+: { timeoutSeconds: timeoutSeconds } } } } } },
          },
        },
        ...
        withAllocateLoadBalancerNodePorts(allocateLoadBalancerNodePorts): { spec+: { serviceTemplate+: { spec+: { allocateLoadBalancerNodePorts: allocateLoadBalancerNodePorts } } } },
        ...
        withClusterIP(clusterIP): { spec+: { serviceTemplate+: { spec+: { clusterIP: clusterIP } } } },
        ...
        withClusterIPs(clusterIPs): { spec+: { serviceTemplate+: { spec+: { clusterIPs: if std.isArray(v=clusterIPs) then clusterIPs else [clusterIPs] } } } },
        ...
        withClusterIPsMixin(clusterIPs): { spec+: { serviceTemplate+: { spec+: { clusterIPs+: if std.isArray(v=clusterIPs) then clusterIPs else [clusterIPs] } } } },
        ...
        withExternalIPs(externalIPs): { spec+: { serviceTemplate+: { spec+: { externalIPs: if std.isArray(v=externalIPs) then externalIPs else [externalIPs] } } } },
        ...
        withExternalIPsMixin(externalIPs): { spec+: { serviceTemplate+: { spec+: { externalIPs+: if std.isArray(v=externalIPs) then externalIPs else [externalIPs] } } } },
        ...
        withExternalName(externalName): { spec+: { serviceTemplate+: { spec+: { externalName: externalName } } } },
        ...
        withExternalTrafficPolicy(externalTrafficPolicy): { spec+: { serviceTemplate+: { spec+: { externalTrafficPolicy: externalTrafficPolicy } } } },
        ...
        withHealthCheckNodePort(healthCheckNodePort): { spec+: { serviceTemplate+: { spec+: { healthCheckNodePort: healthCheckNodePort } } } },
        ...
        withInternalTrafficPolicy(internalTrafficPolicy): { spec+: { serviceTemplate+: { spec+: { internalTrafficPolicy: internalTrafficPolicy } } } },
        ...
        withIpFamilies(ipFamilies): { spec+: { serviceTemplate+: { spec+: { ipFamilies: if std.isArray(v=ipFamilies) then ipFamilies else [ipFamilies] } } } },
        ...
        withIpFamiliesMixin(ipFamilies): { spec+: { serviceTemplate+: { spec+: { ipFamilies+: if std.isArray(v=ipFamilies) then ipFamilies else [ipFamilies] } } } },
        ...
        withIpFamilyPolicy(ipFamilyPolicy): { spec+: { serviceTemplate+: { spec+: { ipFamilyPolicy: ipFamilyPolicy } } } },
        ...
        withLoadBalancerClass(loadBalancerClass): { spec+: { serviceTemplate+: { spec+: { loadBalancerClass: loadBalancerClass } } } },
        ...
        withLoadBalancerIP(loadBalancerIP): { spec+: { serviceTemplate+: { spec+: { loadBalancerIP: loadBalancerIP } } } },
        ...
        withLoadBalancerSourceRanges(loadBalancerSourceRanges): { spec+: { serviceTemplate+: { spec+: { loadBalancerSourceRanges: if std.isArray(v=loadBalancerSourceRanges) then loadBalancerSourceRanges else [loadBalancerSourceRanges] } } } },
        ...
        withLoadBalancerSourceRangesMixin(loadBalancerSourceRanges): { spec+: { serviceTemplate+: { spec+: { loadBalancerSourceRanges+: if std.isArray(v=loadBalancerSourceRanges) then loadBalancerSourceRanges else [loadBalancerSourceRanges] } } } },
        ...
        withPorts(ports): { spec+: { serviceTemplate+: { spec+: { ports: if std.isArray(v=ports) then ports else [ports] } } } },
        ...
        withPortsMixin(ports): { spec+: { serviceTemplate+: { spec+: { ports+: if std.isArray(v=ports) then ports else [ports] } } } },
        ...
        withPublishNotReadyAddresses(publishNotReadyAddresses): { spec+: { serviceTemplate+: { spec+: { publishNotReadyAddresses: publishNotReadyAddresses } } } },
        ...
        withSelector(selector): { spec+: { serviceTemplate+: { spec+: { selector: selector } } } },
    ...
    template: {
      ...
      spec: {
        ...
        ephemeralContainers: {
          ...
          '#withResizePolicyMixin':: d.fn(help='"Resources resize policy for the container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resizePolicy', type=d.T.array)]),
          withResizePolicyMixin(resizePolicy): { resizePolicy+: if std.isArray(v=resizePolicy) then resizePolicy else [resizePolicy] },
          '#withRestartPolicy':: d.fn(help='"Restart policy for the container to manage the restart behavior of each\\ncontainer within a pod.\\nYou cannot set this field on ephemeral containers."', args=[d.arg(name='restartPolicy', type=d.T.string)]),
          withRestartPolicy(restartPolicy): { restartPolicy: restartPolicy },
          '#withRestartPolicyRules':: d.fn(help='"Represents a list of rules to be checked to determine if the\\ncontainer should be restarted on exit. You cannot set this field on\\nephemeral containers."', args=[d.arg(name='restartPolicyRules', type=d.T.array)]),
          withRestartPolicyRules(restartPolicyRules): { restartPolicyRules: if std.isArray(v=restartPolicyRules) then restartPolicyRules else [restartPolicyRules] },
          '#withRestartPolicyRulesMixin':: d.fn(help='"Represents a list of rules to be checked to determine if the\\ncontainer should be restarted on exit. You cannot set this field on\\nephemeral containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='restartPolicyRules', type=d.T.array)]),
          withRestartPolicyRulesMixin(restartPolicyRules): { restartPolicyRules+: if std.isArray(v=restartPolicyRules) then restartPolicyRules else [restartPolicyRules] },
          '#withStdin':: d.fn(help='"Whether this container should allocate a buffer for stdin in the container runtime. If this\\nis not set, reads from stdin in the container will always result in EOF.\\nDefault is false."', args=[d.arg(name='stdin', type=d.T.boolean)]),
        ...
        securityContext: {
          ...
          appArmorProfile: {
            '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { spec+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { spec+: { securityContext+: { appArmorProfile+: { type: type } } } } } },
          },
          ...
          withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { template+: { spec+: { securityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } } } },
        ...
        '#withHostnameOverride':: d.fn(help="\"HostnameOverride specifies an explicit override for the pod's hostname as perceived by the pod.\\nThis field only specifies the pod's hostname and does not affect its DNS records.\\nWhen this field is set to a non-empty string:\\n- It takes precedence over the values set in `hostname` and `subdomain`.\\n- The Pod's hostname will be set to this value.\\n- `setHostnameAsFQDN` must be nil or set to false.\\n- `hostNetwork` must be set to false.\\n\\nThis field must be a valid DNS subdomain as defined in RFC 1123 and contain at most 64 characters.\\nRequires the HostnameOverride feature gate to be enabled.\"", args=[d.arg(name='hostnameOverride', type=d.T.string)]),
        withHostnameOverride(hostnameOverride): { spec+: { template+: { spec+: { hostnameOverride: hostnameOverride } } } },
        ...
        '#workloadRef':: d.obj(help='"WorkloadRef provides a reference to the Workload object that this Pod belongs to.\\nThis field is used by the scheduler to identify the PodGroup and apply the\\ncorrect group scheduling policies. The Workload object referenced\\nby this field may not exist at the time the Pod is created.\\nThis field is immutable, but a Workload object with the same name\\nmay be recreated with different policies. Doing this during pod scheduling\\nmay result in the placement not conforming to the expected policies."'),
        workloadRef: {
          '#withName':: d.fn(help="\"Name defines the name of the Workload object this Pod belongs to.\\nWorkload must be in the same namespace as the Pod.\\nIf it doesn't match any existing Workload, the Pod will remain unschedulable\\nuntil a Workload object is created and observed by the kube-scheduler.\\nIt must be a DNS subdomain.\"", args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { template+: { spec+: { workloadRef+: { name: name } } } } },
          '#withPodGroup':: d.fn(help="\"PodGroup is the name of the PodGroup within the Workload that this Pod\\nbelongs to. If it doesn't match any existing PodGroup within the Workload,\\nthe Pod will remain unschedulable until the Workload object is recreated\\nand observed by the kube-scheduler. It must be a DNS label.\"", args=[d.arg(name='podGroup', type=d.T.string)]),
          withPodGroup(podGroup): { spec+: { template+: { spec+: { workloadRef+: { podGroup: podGroup } } } } },
          '#withPodGroupReplicaKey':: d.fn(help='"PodGroupReplicaKey specifies the replica key of the PodGroup to which this\\nPod belongs. It is used to distinguish pods belonging to different replicas\\nof the same pod group. The pod group policy is applied separately to each replica.\\nWhen set, it must be a DNS label."', args=[d.arg(name='podGroupReplicaKey', type=d.T.string)]),
          withPodGroupReplicaKey(podGroupReplicaKey): { spec+: { template+: { spec+: { workloadRef+: { podGroupReplicaKey: podGroupReplicaKey } } } } },
        },
      },
    },
