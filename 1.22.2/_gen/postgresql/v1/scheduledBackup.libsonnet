{
  ...
  '#spec':: d.obj(help='"Specification of the desired behavior of the ScheduledBackup.\\nMore info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
  spec: {
    ...
    '#withSchedule':: d.fn(help='"The schedule does not follow the same format used in Kubernetes CronJobs\\nas it includes an additional seconds specifier,\\nsee https://pkg.go.dev/github.com/robfig/cron#hdr-CRON_Expression_Format"', args=[d.arg(name='schedule', type=d.T.string)]),
